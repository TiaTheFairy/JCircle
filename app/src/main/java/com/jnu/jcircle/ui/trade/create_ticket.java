        ...
        tickets_new_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if((!tickets_new_type_delivery.isChecked()&&!tickets_new_type_takeout.isChecked()) ||
                    ...
                    Toast.makeText(create_ticket.this, getString(R.string.ticket_new_invalidTip), Toast.LENGTH_LONG).show();
                }
                else{
                    ...
                    alertClaim.setMessage(getString(R.string.ticket_new_message) + tip);
