...
public class TradeFragment extends Fragment {
    ...
    private class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.MyViewHolder>{
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.getTickets_state().setText(tradeViewModelList.get(position).getTicketState());
            holder.getTickets_income().setText(tradeViewModelList.get(position).getTicketIncome());
